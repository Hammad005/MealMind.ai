...
const Reviews = () => {
  ...
  return (
    <div  className="container mx-auto max-w-6xl px-4 mt-20">
      {/* Showcase Header */}
      <div ref={sectionRef} className="dark:bg-card/90 bg-primary/30 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
        <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-primary/40 dark:bg-background/70">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-primary font-medium">Recipe Showcase</span>
          </div>
          <div className="text-sm text-white">AI-Generated Meals</div>
        </div>
          ...
          >
            <CardHeader className="px-5 py-0">
              <div className="grid grid-cols-[auto_1fr] gap-4 mb-4">
                ...
                <div>
                  <CardTitle className="text-xl text-primary font-bold">{entry.name}</CardTitle>
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-foreground">{entry.recipe.name}</h3>
                    <p className="text-sm text-muted-foreground">{entry.recipe.category}</p>
                  </div>
                </div>
